...
type StreamingAvatarContextProps = {
  ...
  messages: Message[];
  setMessages: React.Dispatch<React.SetStateAction<Message[]>>; // ADDED: setMessages function
  clearMessages: () => void;
...
const StreamingAvatarContext = React.createContext<StreamingAvatarContextProps>(
  {
    ...
    setStream: () => {},
    messages: [],
    setMessages: () => {}, // ADDED: Default setMessages function
    clearMessages: () => {},
    handleUserTalkingMessage: () => {},
    handleStreamingTalkingMessage: () => {},
    handleEndMessage: () => {},
...
const useStreamingAvatarMessageState = () => {
  ...
  return {
    messages,
    setMessages, // ADDED: Expose setMessages function
    clearMessages,
    handleUserTalkingMessage,
    handleStreamingTalkingMessage,
    handleEndMessage,
